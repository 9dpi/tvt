...
<style>
    @font-face {
        ...
        src: url('https://unpkg.com/98.css@0.1.4/dist/ms_sans_serif.woff2') format('woff2');
        font-weight: normal;
        font-style: normal;
    }
    ...
    * { border-radius: 0 !important; }
    ...
    .tvt-card, .chat-bubble, .analysis-card, .research-card, .solution-box {
        background-color: #c0c0c0 !important;
        border: 1px solid #000000 !important;
        box-shadow: inset 1px 1px #ffffff, inset -1px -1px #808080, 1px 1px #404040 !important;
    ...
    .stTextArea textarea, .stTextInput input, .stSelectbox [data-baseweb="select"] {
        ...
        box-shadow: inset 1px 1px #000000, inset -1px -1px #ffffff, 1px 1px #808080 !important;
        color: #000000 !important;
    }
    ...
    .stButton > button:active {
        box-shadow: inset 1px 1px #808080, inset -1px -1px #ffffff, 0 0 0 1px #000 !important;
    }
    ...
    .chat-bubble.user { background-color: #d8d8d8 !important; }

    .stProgress > div > div { background-color: #000080 !important; }
...
# ─── Theme Injection ────────────────────────────────────────────────────────
if st.session_state.theme == "Windows 98":
...
with st.sidebar:
    ...
    # Theme selection
    st.markdown("---")
    theme_options = ["Hiện đại", "Windows 98"]
